...
```
    ...
    ##  Elapsed Time: 0.75 seconds (Warm-up)
    ##                0.619 seconds (Sampling)
    ##                1.369 seconds (Total)
    ## 
    ## 
    ...
    ##  Elapsed Time: 0.843 seconds (Warm-up)
